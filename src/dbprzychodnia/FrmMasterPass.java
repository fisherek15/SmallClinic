 ...
 * @author Adrian
 */
public class FrmMasterPass extends javax.swing.JFrame {
    
   private static final String password = "pass";
    
   public void checkPass() {
       
        char[] pass = txtPasswordField.getPassword();
    ...
    /**
     * Creates new form FrmMasterPass
     */
    public FrmMasterPass() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FUNKCJE DODATKOWE - LOGOWANIE");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        this.setTitle("Panel dodatkowy - logowanie");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMasterPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMasterPass().setVisible(true);
            }
        });
    }
